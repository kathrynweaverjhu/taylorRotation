...
'''input shape and autoencoder architecture_2: 4004 -> 5000 -> 1000 -> 500 -> 250 -> 2 -> 250 -> 500 -> 1000 -> 5000 -> 4004'''
n = tf.keras.Sequential()
n.add(keras.layers.Dense(5000, activation='elu', input_shape = (int(merged_train_arrays.shape[1]),)))
