...
"""
Usage: ~/taylorRotation/preprocessing/tensorMatrix_simplifyClasses.py --outfile filename.npz --IDEAScalls ~/taylorRotation/preprocessing/data/files --RNAseq ~/taylorRotation/preprocessing/data/files (scriptseq3.v3.filter4ChrLocAvgkw2.bed) --ATACseq ~/taylorRotation/preprocessing/data/files (VISIONmusHem_ccREs_filter2kw.txt)
"""
...
for file in fileList1: #IDEAScalls ##filter out if label == 0
    ...
    for line in open(file):
        ...
        if ideasLabel == 0:
            ...
            ideasLabel = newLabel[ideasLabel]
...
for cell_type in cell_types:
    ...
    #bedtools_closest_out = subprocess.check_output("bedtools closest -k 3 -a /Users/cmdb/taylorRotation/preprocessing/data/500ideasVisionV20p8Seg{}getfa.bed -b {} -t last".format(cell_type,file2), shell=True).decode("utf-8").splitlines()
...
for cell_type in cell_types:
    ...
    #bedtools_out = subprocess.check_output("bedtools intersect -loj -a /Users/cmdb/taylorRotation/preprocessing/data/500ideasVisionV20p8Seg{}getfa.bed -b {}".format(cell_type, file3), shell=True).decode("utf-8").splitlines()
