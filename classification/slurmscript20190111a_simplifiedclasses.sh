...
#SBATCH --job-name=Classification_simplified_scaleDown1_part1
#SBATCH --time=72:0:0
#SBATCH --ntasks-per-node=48
#SBATCH --mem=1000000M
#SBATCH --mail-type=ALL
#SBATCH --mail-user=kweave23@jhu.edu
#SBATCH --output=outfile_simplifiedClasses_scaleDown1_part1.out
...
#python 
#/home-3/kweave23@jhu.edu/work/users/kweave23/classification_scripts/Classification#Model_simplifiedClasses.py 
#> printStatements2_simplify.out
