...
'''Usage: ./ClassificationModel_simplifiedClasses_refinedGrid.py --SavedMatricesFile --CheckpointPath --TestArrays --dumpBestEstimator [--n_iter_RSCV] [--desiredScalingFactor]
        to be run following tensorMatrix_simplifyClasses.py'''

parser = ap.ArgumentParser(description='Training randomly subsampled data (with simplified classes) with hyperparameter optimization by RandomizedSearchCV using a refined grid')
...
with np.load(savedMatrices) as npzfile: #"savedMatrices_simplifiedClasses.npz"
