...
f = open('testArrays_simplifiedClasses_refinedGrid.npz', 'wb')
...
class nn_wrap(skb.BaseEstimator, skb.ClassifierMixin):
    ...
    def fit(self, X, y):
        ...
        checkpoint_path = '/home-3/kweave23@jhu.edu/work/users/kweave23/out/checkpoints/scaleDown1_simplifiedClasses_refinedGrid_{}_{}_{}_{}.ckpt'.format(self.epochs, self.hiddenNodes, self.inputShape, self.alpha)
